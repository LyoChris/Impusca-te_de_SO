...
typedef volatile struct {volatile int a,b,c;} edges;
typedef volatile struct {volatile int a,b,c,r;} edgesr;
typedef volatile struct {volatile int a,b,c,P,S;} triangle;
